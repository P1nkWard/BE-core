...
public class MemberController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestParam String id, @RequestParam String pw, @RequestHeader(name = "referer") String referer) {
        ...
        return ResponseEntity.status(401).headers(httpHeaders).body("로그인 실패");
    }
